...
def get_metrics(img1, img2, loss_fn):
    ...
    count=1
    msed2=0
    # print("\n\n", torch.max(img1[0]), img1[1][1][1].item(), img1[2][2][2].item(), img1[1][3][3].item(), "\n\n")
    ...
    # print(f"Count : {count}, Count2 : {count2}, MSE value : {MSE}, msed value : {msed/(3*512*512)}, msed2 : {msed2/(3*count)}\n")
    PSNR = 20*math.log10(2./math.sqrt(msed2/(3*count)))
    # PSNR = 1
    PSNR1 = 20*math.log10(2./math.sqrt(MSE+0.000001))

    return lpip_s.squeeze().item(), PSNR, PSNR1